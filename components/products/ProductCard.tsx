...
export default function ProductCard({ product }: ProductCardProps) {
  return (
    <div className="card card-compact bg-white-100 border border-gray-300 shadow-md transition-shadow hover:shadow-lg">
      ...
      <div className="card-body">
        <h2
          className="card-title text-base line-clamp-2"
        ...
        <div className="text-sm text-gray-500">
          <p>
            Stock:{" "}
            {product.productStock > 0 ? product.productStock : "Out of Stock"}
          </p>
