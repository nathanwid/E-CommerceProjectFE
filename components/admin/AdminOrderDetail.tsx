...
export default async function OrderDetail({
  ...
  return (
    <>
      <div className="grid md:grid-cols-4 gap-4 bg-white p-8 rounded-lg shadow-md border border-gray-300 mb-8">
        <div>
        ...
        <div>
          ...
          {data.address.addressLine2 && (
            <p className="text-sm text-gray-600">{data.address.addressLine2}</p>
          )}
      ...
      <OrderStatusForm currentStatus={data.status} orderId={data.orderId} />
