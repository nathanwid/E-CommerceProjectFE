...
export async function getProducts(params: GetProductsParams = {}): Promise<PaginatedProductResponse> {
  // Set default pagination if not provided
  const pageNumber = params.pageNumber || 1;
  const pageSize = params.pageSize || 12; // Or your desired default page size
